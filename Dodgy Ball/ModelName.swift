...
//  Dodgy Ball
//
//  Created by Seth Rodgers on 7/26/15.
    ...
    var modelName: String
        {
            ...
            switch identifier
            {
            case "iPod5,1":                                 return "iPod Touch"
            ...
            case "iPad4,4", "iPad4,5", "iPad4,6":           return "iPad Mini"
            case "iPad4,7", "iPad4,8", "iPad4,9":           return "iPad Mini"
            case "iPad5,1", "iPad5,2":                      return "iPad Mini"
